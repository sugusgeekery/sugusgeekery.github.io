      ...
      <div class="design-item-content" v-if="design.step > a.label">
        ...
        <div class="design-item-content-button" v-if="b === 0">
          <span
            ...
            @click="checkProgramme({ checkResult: 1, step: 1 })"
            >通过</span
          >
          <span
            class="design-item-content-button-text"
            @click="checkProgramme({ checkResult: 0, step: 1 })"
            >驳回</span
          >
        </div>
      </div>
...
export default class DesignAcceptanceView extends Vue {
  @State("design")
