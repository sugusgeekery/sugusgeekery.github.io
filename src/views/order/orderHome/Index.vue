          ...
          <div class="filter-items">
            <div class="filter-item">
              <div class="filter-item-content">
                <el-select
                  :model-value="order.projectList[order.projectIndex] ? order.projectList[order.projectIndex].text : ''"
            ...
            <div class="filter-item">
              <div class="filter-item-content">
                <el-select
                  :model-value="order.statusList[order.statusIndex] ? order.statusList[order.statusIndex].text : ''"
...
export default defineComponent({
  ...
  setup() {
    ...
    const advantage: Advantage | any = computed(() => store.state.order.advantage);
    const order: Order | any = computed(() => store.state.order.order);

    const getMyBidAdvantage: Function = (params: any) => store.dispatch(`order/${ActionTypes.GetMyBidAdvantage}`, params);
    const updatePageNum: Function = (params: any) => store.dispatch(`order/${ActionTypes.UpdatePageNum}`, params);
    const updatePageSize: Function = (params: any) => store.dispatch(`order/${ActionTypes.UpdatePageSize}`, params);
    const updateProjectIndex: Function = (params: any) => store.dispatch(`order/${ActionTypes.UpdateProjectIndex}`, params);
    const updateStatusIndex: Function = (params: any) => store.dispatch(`order/${ActionTypes.UpdateStatusIndex}`, params);
    const updateOrderNo: Function = (params: any) => store.dispatch(`order/${ActionTypes.UpdateOrderNo}`, params);
    const getOrderDetail: Function = (params: any) => store.dispatch(`order/${ActionTypes.GetOrderDetail}`, params);
